...
1. Clone the `microservices-demo` repository locally.
    ...
    ```sh
    git clone https://github.com/linux-cnf/microservices-demo \
...
1. Create an API key in the [Google Cloud credentials page](https://console.cloud.google.com/apis/credentials) with permissions for "Generative Language API", and make note of the secret key. Do not commit the key or the substituted manifest.
